  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: '1',
      role: 'assistant',
      content: "Hello! I'm your AI health assistant. I'm here to help you with health advice, answer questions about your wellness journey, and provide personalized recommendations. How can I assist you today?",
    },
  ]);
  ...
  const handleSend = async () => {
    ...
    setTimeout(() => {
      const assistantMessage: Message = {
        ...
        role: 'assistant',
        content: "This is a placeholder response. In the full implementation, this would connect to your AI backend to provide personalized health recommendations based on your question.",
      };
