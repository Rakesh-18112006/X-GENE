      ...
      >
        ...
        <div className="glass-effect rounded-2xl p-8 border border-[#2a2d3a]">
          <div className="text-center mb-8">
            ...
            <p className="text-[#a0a3bd]">Start your health journey today</p>
          </div>

          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="relative">
              <User className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-[#6b6f8a]" />
              <Input
                type="text"
            ...
            <div className="flex items-start gap-2 text-sm">
              <input
                type="checkbox"
                required
                className="mt-1 w-4 h-4 rounded border-[#2a2d3a] bg-[#1a1c24] text-[#00d9ff] focus:ring-2 focus:ring-[#00d9ff]/20"
              />
